<template>
  <div class="app-container">
    ...
    <el-table border v-loading="loading" :data="itemList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="规格" align="center" prop="specification" v-if="columns[2].visible"/>
      <el-table-column label="分类" align="center" prop="itemTypeName" v-if="columns[3].visible"/>
      <el-table-column label="单位类别" align="center" prop="unit" v-if="columns[4].visible"/>
      <el-table-column label="单价" align="center" prop="unitPrice" v-if="columns[5].visible"/>
      <el-table-column label="所属货架" align="center" prop="rackName" v-if="columns[6].visible"/>
      <el-table-column label="所属库区" align="center" prop="areaName" v-if="columns[7].visible"/>
      <el-table-column label="所属仓库" align="center" prop="warehouseName" v-if="columns[8].visible"/>
      <el-table-column label="现有库存" align="center" prop="quantity" v-if="columns[9].visible"/>
      <el-table-column label="生产日期" align="center" prop="productionDate" width="180" v-if="columns[10].visible">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.productionDate, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="有效期" align="center" prop="expiryDate" width="180" v-if="columns[11].visible">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.expiryDate, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="批次" align="center" prop="batch" v-if="columns[12].visible"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="90px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="分类" prop="itemType">
              <treeselect v-model="form.itemType" :options="itemTypeOptions" :show-count="true" :normalizer="normalizer" placeholder="请选择资产类型" />
            </el-form-item>
          </el-col>          
          <el-col :span="12">
        ...
        <el-form-item label="说明" prop="remark">
          <el-input type="textarea" :rows="2" v-model="form.remark" placeholder="说明..." />
        </el-form-item>
      </el-form>
