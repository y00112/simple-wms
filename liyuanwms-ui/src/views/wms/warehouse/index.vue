<template>
  <div class="container">
    <el-card class="box-card-title">
      <el-row>
        <el-col :span="4">
          <el-input v-model="queryWarehouseParam" placeholder="请输入仓库名称">
            <el-button slot="append" icon="el-icon-search" v-hasPermi="['wms:warehouse:list']"
              @click="queryWarehouse"></el-button>
          </el-input>
        </el-col>
        <el-col :span="8">
          <el-button type="success" plain style="margin-left: 10px;" icon="el-icon-plus" @click="handleAddWarehouse"
            v-hasPermi="['wms:warehouse:add']">新增仓库</el-button>
        </el-col>
      </el-row>
    </el-card>
    <el-empty description="暂无仓库" v-if="wmsWarehouseList.length == 0"></el-empty>
    <el-card v-else class="box-card-body">
      <el-tabs 
     ...
     @tab-click="handleTabClick">
        <el-tab-pane 
        v-for="(warehouse, index) in wmsWarehouseList" 
          :key="warehouse.id"
          ...
          <el-card class="box-card">
            <el-descriptions title="基本信息" direction="vertical" :column="4" border>
              <template slot="extra">
                <el-button type="primary" size="small" @click="handleUpdateWarehouse(warehouse.id)"
          ...
          <el-card class="box-card" style="margin-top: 5px;">
            ...
            <div class="text item">
              <el-row>
                <el-col :span="4">
                  <el-input v-model="queryAreaParam" size="small" placeholder="请输入库区名称">
                    <el-button slot="append" icon="el-icon-search" @click="queryArea"></el-button>
                  </el-input>
                </el-col>
                <el-col :span="8">
                  <el-button type="success" size="small" plain style="margin-left: 10px;" icon="el-icon-plus"
                    @click="handleAddArea(warehouse.id)" v-hasPermi="['wms:area:add']">新增库区</el-button>
                </el-col>
              </el-row>
              <template>
                <el-table :data="wmsAreaList" height="310" border style="width: 100%; margin-top: 10px;">
                  <el-table-column prop="areaNo" label="编号" align="center">
                  </el-table-column>
                  <el-table-column prop="areaName" label="名称" align="center">
                  </el-table-column>
                  <el-table-column prop="id" label="货架编号" align="center">
                    <template slot-scope="scope">
                    <router-link :to="'/wms/rack/index/' + scope.row.id" class="link-type">
                  ...
                  <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                    <template slot-scope="scope">
                      <el-button size="small" type="primary" icon="el-icon-edit" @click="handleUpdateArea(scope.row)"
                        v-hasPermi="['wms:area:edit']">修改</el-button>
                      <el-button size="small" type="danger" icon="el-icon-delete" @click="handleDeleteArea(scope.row)"
    ...
    <!-- 添加或修改仓库对话框 -->
    <el-dialog :title="title" :visible.sync="openWarehouse" width="40%">
      <el-form ref="warehouseForm" :model="warehouseForm" :rules="rulesWarehouse" label-width="80px">
    ...
    <!-- 添加或修改库区对话框 -->
    <el-dialog :title="title" :visible.sync="openArea" width="40%" append-to-body>
      <el-form ref="areaForm" :model="areaForm" :rules="rulesArea" label-width="100px">
        ...
        <el-form-item label="所属仓库ID" prop="warehouseId">
          <el-input v-model="areaForm.warehouseId" placeholder="请输入所属仓库ID" disabled />
        </el-form-item>
        <el-form-item label="备注" prop="remark">
