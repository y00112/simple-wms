  ...
  <div class="app-container">
    <el-form :model="queryParams"
      ...
      <el-form-item label="编号"
                    prop="rackNo">
        <el-input v-model="queryParams.rackNo"
                  placeholder="请输入编号"
                  clearable
      ...
      <el-form-item label="名称"
                    prop="rackName">
        <el-input v-model="queryParams.rackName"
                  placeholder="请输入名称"
                  clearable
                  @keyup.enter.native="handleQuery" />
      </el-form-item>
      ...
      <el-form-item label="所属仓库"
                    prop="warehouseId">
        <el-input v-model="queryParams.warehouseId"
                  placeholder="请输入所属仓库"
                  clearable
                  @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-row :gutter="10"
      ...
      <el-col :span="1.5">
        <el-button type="primary"
                   ...
                   size="mini"
                   @click="handleAdd"
                   v-hasPermi="['system:rack:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
      ...
      <el-col :span="1.5">
        <el-button type="warning"
                   ...
                   size="mini"
                   @click="handleExport"
                   v-hasPermi="['system:rack:export']">导出</el-button>
      </el-col>
